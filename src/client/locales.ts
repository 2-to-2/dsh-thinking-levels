...
export const zh = {
  ...
  'card.capabilities.hint': '直接读写 llm-pi-ai 配置：视觉决定图片输入，思考/档位决定 reasoning_effort 支持面，thinkingFormat 决定 wire 序列化格式（如 qwen 用 enable_thinking）。',
  ...
  'card.capabilities.thinking.inherit': '继承',
  'card.capabilities.thinking.on': '开启',
  'card.capabilities.thinking.off': '关闭',
...
export const en: Record<keyof typeof zh, string> = {
  ...
  'card.capabilities.hint': 'Reads and writes the llm-pi-ai config directly: vision gates image input, thinking/efforts declare the reasoning_effort surface, thinkingFormat picks the wire serialization (e.g. qwen → enable_thinking).',
  ...
  'card.capabilities.thinking.inherit': 'Inherit',
  'card.capabilities.thinking.on': 'Enabled',
  'card.capabilities.thinking.off': 'Disabled',
